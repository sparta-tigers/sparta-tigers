...
public class WebSocketHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        // 사용자 저장
        LiveBoardUser sessionUser =
                LiveBoardUser.builder()
                        ...
                        .nickname(
                                "비회원"
                                        + UUID.randomUUID()
                                                .toString()
                                                .substring(0, 5)) // TODO: 익명 닉네임 랜덤 생성하기~!
                        .isMember(false)
    ...
    public void handleTextMessage(WebSocketSession session, TextMessage textMessage)
            throws Exception {
        // 역직렬화
        LiveBoardMessage rawMessage =
                objectMapper.readValue(textMessage.getPayload(), LiveBoardMessage.class);
        ...
        // 메세지 객체 생성
        LiveBoardMessage message =
                new LiveBoardMessage(
                        sender.getRoomId(),
                        sender.getUserId(),
                        sender.getNickname(),
