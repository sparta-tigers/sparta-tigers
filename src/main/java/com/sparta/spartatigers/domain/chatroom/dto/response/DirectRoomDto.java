...
public class DirectRoomDto {
	...
	public DirectRoomDto(Long directRoomId, Long exchangeRequestId, Long receiverId, String receiverNickname,
		boolean isCompleted, LocalDateTime completedAt, LocalDateTime createdAt) {
	...
	public static DirectRoomDto from(DirectRoom room, Long currentUserId) {
		User opponent = room.getSender().getId().equals(currentUserId)
			? room.getReceiver()
			: room.getSender();
